...
class Snake {
        ...
        private boolean eat() {
                ...
                if (derection == 1 && (head.x - 10) == food.x && head.y == food.y) return true;
                else if (derection == 2 && head.x == food.x && (head.y - 10) == food.y) return true;
                else if (derection == 3 && (head.x + 10) == food.x && head.y == food.y) return true;
                else if (derection == 4 && head.x == food.x && (head.y + 10) == food.y) return true;
                else return false;
        }
        private boolean collsion() {
                Node node = body.get(0);
                if (derection == 1 && node.x == 0) return true;
                else if (derection == 2 && node.y == 0) return true;
                else if (derection == 3 && node.x == 200) return true;
                else if (derection == 4 && node.y == 200) return true;
                Node temp = null;
                int i = 0;
        ...
        public void changeDer(int newDer) {
                if (derection % 2 != newDer % 2) derection = newDer;
        }
        public void move() {
                if (eat()) {
                        body.add(0, food);
